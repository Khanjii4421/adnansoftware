...
const Footer = () => {
  return (
    <footer className="bg-blue-500/20 backdrop-blur-md border-t border-blue-300/30 py-4 mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-700">
          <div className="mb-2 md:mb-0">
            ...
            <p className="text-xs text-gray-600 mt-1">High Quality Management System</p>
          </div>
